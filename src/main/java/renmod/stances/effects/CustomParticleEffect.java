...
public class CustomParticleEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vX;
    private float vY;
    ...
    public CustomParticleEffect(float r, float g, float b, float a) {
    ...
    public CustomParticleEffect(float r, float g, float b){
        this(r,g,b,0);
    }
