package renmod.CustomCharacter;
...
import renmod.cards.ren.basic.Strike;
import renmod.cards.ren.common.BloodCarbon;
...
public class RenCharacter extends CustomPlayer{
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Ren"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass REN_CHARACTER;
        ...
        public static void registerColor() {
            BaseMod.addColor(Meta.CARD_COLOR, cardColor,
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new RenCharacter(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public RenCharacter() {
        super(getNames()[0], Meta.REN_CHARACTER,
