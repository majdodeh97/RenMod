...
public class RensDagger extends BaseCarbonCard {

    public static final String ID = makeID("RensDagger");
    ...
    private static final int DAMAGE_PERCENT_UPGRADE = 50;
